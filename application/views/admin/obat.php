...
<nav class="navbar navbar-expand-lg navbar-light fixed-top shadow bg-white" style="background-color: #fff;" >
	...
	<div id="box">
        ...
        <table class="table table-hover" id="tablee">
            ...
            <tbody>
			<?php
              $data = $mysqli->query("SELECT * FROM daftarobat");
              $no = 0;
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="prosestambah.php">
        ...
        <div class="form-group">
		  ...
		  <textarea class="form-control" rows="5" id="formGroupExampleInput" placeholder="Deskripsi" name="deskrip"required></textarea>
        </div>
      </div>
  ...
  <div class="modal fade" id="<?php echo $row1['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="form-group">
          <label for="formGroupExampleInput">Deskripsi</label>
		  <textarea class="form-control" rows="5" id="formGroupExampleInput" placeholder="Deskripsi" name="deskrip" required><?php echo $row1['deskrip'] ?></textarea>
        </div>
